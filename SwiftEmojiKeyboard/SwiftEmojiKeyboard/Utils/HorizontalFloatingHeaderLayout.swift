...
public class HorizontalFloatingHeaderLayout: UICollectionViewLayout {
    ...
    private func itemSize(for indexPath:IndexPath) -> CGSize {
        guard let collectionView = collectionView, let delegate = collectionView.delegate as? HorizontalFloatingHeaderLayoutDelegate else {
                return CGSize.zero
        }
    ...
    private func headerSize(forSection section:Int) -> CGSize {
        guard let collectionView = collectionView, let delegate = collectionView.delegate as? HorizontalFloatingHeaderLayoutDelegate, section >= 0 else {
                return CGSize.zero
        }
